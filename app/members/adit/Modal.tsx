  ...
  return (
    <div className="fixed inset-0 z-1000 flex items-center justify-center p-3 sm:p-5 md:p-8">
      ...
      <div
        ...
        className="relative w-full max-w-3xl max-h-[88vh] overflow-hidden bg-[#0F1923] border border-[#303946] shadow-[0_0_40px_rgba(0,0,0,0.8)] z-10 flex flex-col text-[#ECE8E1]"
        style={{
          clipPath:
      ...
      >
        ...
        {!isUnlocked ? (
          ...
          <div className="w-full h-full flex flex-col overflow-hidden">
            {/* Top Tactical Sticky Header Banner (Stays fixed when scrolling biodata) */}
            <div className="sticky top-0 z-30 shrink-0 bg-[#161F28] border-b border-[#303946] px-4 sm:px-6 py-3 sm:py-3.5 flex justify-between items-center select-none text-[#ECE8E1] shadow-[0_2px_10px_rgba(0,0,0,0.5)]">
              {/* Left Status Badge */}
              <div className="flex items-center gap-2 font-valorant-title font-bold text-sm sm:text-base uppercase tracking-wider text-[#ECE8E1]">
                <ShieldCheck size={18} className="text-[#FF4655]" />
                <span>SHARPSHOOTER // AGENT PROFILE</span>
              </div>

              {/* Right Controls: Play Again + Close Button */}
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={() => setIsUnlocked(false)}
                  className="px-3 py-1 bg-[#1F2326] hover:bg-[#FF4655] text-[#ECE8E1] hover:text-white border border-[#303946] hover:border-[#FF4655] font-valorant-mono text-xs font-semibold tracking-wider transition-all duration-200 cursor-pointer flex items-center gap-1.5"
                  style={{
                    clipPath:
            ...
            <div
              ref={profileCardRef}
              className="flex-1 overflow-y-auto no-scrollbar p-5 sm:p-8 md:p-10 flex flex-col gap-6 sm:gap-8 bg-[#0F1923] text-[#ECE8E1] relative z-10"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                {/* Tactical Connect: Instagram, LinkedIn, CV */}
                <div className="flex flex-col gap-2.5">
                  <h4 className="font-valorant-sub font-bold text-base sm:text-lg text-[#ECE8E1] uppercase tracking-wider flex items-center gap-2">
                    <Instagram size={16} className="text-[#FF4655]" />
                    <span>Agent Links // Socials</span>
                  </h4>
                  <div className="flex flex-col gap-2">
                    ...
                    {cleanInstagram && (
                      <div className="flex items-center gap-2">
                        <a
                          ...
                          className="flex-1 inline-flex items-center justify-between gap-2 px-3 sm:px-4 py-2 bg-[#161F28] hover:bg-[#1F2933] border border-[#303946] hover:border-[#FF4655] font-valorant-mono text-xs sm:text-sm text-[#ECE8E1] transition-all truncate"
                          style={{
                            clipPath:
                              "polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))",
                          }}
                        >
                          <div className="flex items-center gap-2 truncate">
                            <Instagram size={14} className="text-[#FF4655] shrink-0" />
                        ...
                        <button
                          ...
                          className="p-2.5 bg-[#161F28] hover:bg-[#FF4655] border border-[#303946] hover:border-[#FF4655] text-[#ECE8E1] hover:text-white transition-all cursor-pointer shrink-0"
                          style={{
                            clipPath:
                              "polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))",
                          }}
                    ...
                    {/* LinkedIn & CV */}
                    <div className="flex items-center gap-2">
                      {rizaData.linkedinUrl && (
                        <a
                          href={
                            rizaData.linkedinUrl.startsWith("http")
                              ? rizaData.linkedinUrl
                              : `https://${rizaData.linkedinUrl}`
                          }
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-[#161F28] hover:bg-[#1F2933] border border-[#303946] hover:border-[#0284c7] font-valorant-mono text-xs text-[#ECE8E1] transition-all truncate"
                          style={{
                            clipPath:
                              "polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))",
                          }}
                      ...
                      {rizaData.cvUrl && (
                        <a
                          href={
                            rizaData.cvUrl.startsWith("http")
                              ? rizaData.cvUrl
                              : `https://${rizaData.cvUrl}`
                          }
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-[#161F28] hover:bg-[#FF4655] border border-[#303946] hover:border-[#FF4655] font-valorant-mono text-xs text-[#ECE8E1] hover:text-white transition-all shrink-0"
                          style={{
                            clipPath:
                              "polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))",
                          }}
